...
export const defaultColor = {
  ...
  textUnActive: '#C7C7C7',
  //StatusBar
  statusbarColor: '#C4C4C4',
  //Unfinished-Document
  unfinishedDoc: '#FAE6E6',
  filterColor: '#E16666',
  placeHolder: '#D6D6D6',
  // background
  lightBlue: '#D8EEEE',
...
export default {
  ...
  checkboxBgColor: `${defaultColor.black}`,
  checkboxSize: 20,
  ...
  // Color
  brandPrimary: `${defaultColor.primary}`,
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c	',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  toolbarDefaultBg: `${defaultColor.white}`,
  toolbarHeight: 52,
  ...
  // InputGroup
  inputFontSize: 14,
  inputBorderColor: `${defaultColor.lightGray}`,
